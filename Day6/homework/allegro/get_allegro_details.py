...
url = 'https://allegro.pl/ogloszenie/chevrolet-corvette-grand-sport-6-2-2017r-targa-ful-7860585442'
filename = 'corvette.html'
...
def get_details(_data):
    ...
    filtered = soup.find(property="og:title")
    print(filtered.get('content'))
    return ''
